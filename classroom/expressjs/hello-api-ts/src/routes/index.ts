...
routes.get(
  ...
  (req, res) => {
    const { name } = res.locals.validated.params as { name: string };
...
routes.get(
  ...
  (req, res) => {
    const { name } = res.locals.validated.query as { name: string };
...
routes.post(
  ...
  (req, res) => {
    const { name } = res.locals.validated.body as { name: string };
